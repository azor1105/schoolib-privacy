...
### Введение
Наша политика конфиденциальности поможет вам понять, какую информацию мы собираем в Darsliklar, как Darsliklar ее использует и какой у вас есть выбор.
Darsliklar создал приложение Darsliklar как бесплатное приложение. Эта СЛУЖБА предоставляется Darsliklar бесплатно и предназначена для использования как есть.
